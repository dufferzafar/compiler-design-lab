#include<stdio.h>
int Fa[ 10][10][10],states[ 2][10],row =0 ,col =0 ,sr=
0 ,sc=0 ,th =0 ,
...
int checkcon( int * arr, int * count) //for doing
this {4,1}={1,2,1}=={1,2}
 {
...
int check ( int i , int j, int c, int * name) ///for
checking is this a new state?
  {
int t,l,f;
for (l =0 ;l <=stat;l ++ )
{
...
int trans ( int i , int j, int t, int c, int * count,
int * arr) //transition o/p for particular i/p on
states
 {
int k =0 ,co,temp;
*count =0 ;
